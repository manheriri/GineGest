                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            {!! Form::select('personalSanitario_id', $users, $appointments->personalSanitario_id, ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
                            {!!Form::label('paciente_id', 'Paciente') !!}
                            <br>
                            {!! Form::select('paciente_id', $users, $appointments->paciente_id, ['class' => 'form-control']) !!}
                        </div>
